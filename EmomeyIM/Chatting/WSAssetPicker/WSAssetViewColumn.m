...
#define ASSET_VIEW_FRAME CGRectMake(0, 0, (100.0f * ([[UIScreen mainScreen] bounds].size.width) / 320), (100.0f * ([[UIScreen mainScreen] bounds].size.width) / 320))
...
#define SELECTED_IMAGE @"space_setting_pic_delete.png"
